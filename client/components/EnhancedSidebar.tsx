...
export function EnhancedSidebar() {
  ...
  const categories = [
    {
      ...
      icon: Smartphone,
      color: 'text-blue-500',
      brands: ['IPhone', 'Samsung', 'Google', 'Vivo', 'Oppo', 'Redmi', 'Realme', 'Xiaomi', 'OnePlus', 'Motorola']
    },
    {
      id: 'smart-tvs',
      name: 'Smart TVs',
  ...
  const retailers = [
    ...
    { id: 'Amazon Fresh', name: 'Amazon Fresh', icon: UtensilsCrossed, color: 'text-red-600' },
    { id: 'Walmart Grocery', name: 'Walmart Grocery', icon: UtensilsCrossed, color: 'text-red-600' },
    { id: 'Instacart', name: 'Instacart', icon: UtensilsCrossed, color: 'text-red-600' },
    { id: 'Carrefour', name: 'Carrefour', icon: UtensilsCrossed, color: 'text-red-600' },
    { id: 'Ocado', name: 'Ocado', icon: UtensilsCrossed, color: 'text-red-600' },
    { id: 'Dunzo', name: 'Dunzo', icon: UtensilsCrossed, color: 'text-red-600' },
    { id: 'Grofers', name: 'Grofers', icon: UtensilsCrossed, color: 'text-red-600' },
    { id: 'BigBasket', name: 'BigBasket', icon: UtensilsCrossed, color: 'text-red-600' },
    { id: 'Blinkit', name: 'Blinkit', icon: UtensilsCrossed, color: 'text-red-600' },
    { id: 'Zepto', name: 'Zepto', icon: UtensilsCrossed, color: 'text-red-600' },
    { id: 'JioMart', name: 'JioMart', icon: UtensilsCrossed, color: 'text-red-600' },
    { id: 'Amazon Pantry India', name: 'Amazon Pantry India', icon: UtensilsCrossed, color: 'text-red-600' },
    { id: 'Tesco Online', name: 'Tesco Online', icon: UtensilsCrossed, color: 'text-red-600' },
    { id: 'Sainsbury’s Online', name: 'Sainsbury’s Online', icon: UtensilsCrossed, color: 'text-red-600' },
    { id: 'Asda Groceries', name: 'Asda Groceries', icon: UtensilsCrossed, color: 'text-red-600' },
    { id: 'Morrisons', name: 'Morrisons', icon: UtensilsCrossed, color: 'text-red-600' },
    { id: 'Kroger', name: 'Kroger', icon: UtensilsCrossed, color: 'text-red-600' },
    { id: 'Target', name: 'Target', icon: UtensilsCrossed, color: 'text-red-600' },
